...
■ 추진목적
 - 〇 공적 말하기 실습 및 평가 분석과 초거대 AI 및 말하기 교육 AI의 인프라 확충을 목적으로, 공적 말하기의 영상과 발표자 전사 스크립트를 한 세트로 구성한 데이터셋 확보
 - 〇 전문가를 통한 공적 말하기의 필수적인 평가 항목 지표 설정 및 데이터 라벨링 설계, 공적 말하기 데이터셋 구축에 특화된 저작도구 개발
 - 〇 데이터셋 전체 공정(수집, 정제, 가공, 품질관리) 과정에 신규 인력 고용으로 일자리 창출

■ 과제 목표
- 〇 공적 말하기 실습 및 평가를 위한 발표 영상 및 음성, 발표 자료 텍스트, 발표 평가 텍스트 데이터셋 구축과 공적 말하기 인식 및 분류, 수준 평가
- 〇 인공지능 학습용 데이터 구축량 
- 〇 800명 이상의 발표자의 음성이 포함된 발표 동영상 2,400 클립 이상
- 〇 공적 말하기 발표 원고 280건 (전사 스크립트800건) 이상(발표 평가 포함)
- 〇 공적 말하기를 교육 및 평가하는 객관적인 교육용 자료로 활용하고 실시간 공적 말하기 관련 코칭 및 피드백 솔루션 제공
